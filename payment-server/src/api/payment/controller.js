...
const createPayment = async (req, res) => {
  ...
  let locale = req.body.language || "vn"; // Simplified locale assignment
...
const retrunThanks = async (req, res) => {
...
module.exports = { createPayment, retrunThanks };
